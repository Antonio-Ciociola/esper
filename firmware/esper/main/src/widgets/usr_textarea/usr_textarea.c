 ...
 *      INCLUDES
 *********************/
#include "usr_textarea_private.h"
 ...
 *      DEFINES
 *********************/
#define MY_CLASS (&usr_textarea_class)

/*Test configuration*/
#ifndef USR_TEXTAREA_DEF_CURSOR_BLINK_TIME
#define USR_TEXTAREA_DEF_CURSOR_BLINK_TIME 400 /*ms*/
#endif

#ifndef USR_TEXTAREA_DEF_PWD_SHOW_TIME
#define USR_TEXTAREA_DEF_PWD_SHOW_TIME 1500 /*ms*/
#endif

#define USR_TEXTAREA_PWD_BULLET_UNICODE 0x2022
 ...
 *  STATIC PROTOTYPES
 **********************/
static void usr_textarea_constructor(const lv_obj_class_t *class_p, lv_obj_t *obj);
static void usr_textarea_destructor(const lv_obj_class_t *class_p, lv_obj_t *obj);
static void usr_textarea_event(const lv_obj_class_t *class_p, lv_event_t *e);
...
static const lv_property_ops_t properties[] = {
    {
        ...
        .setter = usr_textarea_set_text,
        .getter = usr_textarea_get_text,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_PLACEHOLDER_TEXT,
        .setter = usr_textarea_set_placeholder_text,
        .getter = usr_textarea_get_placeholder_text,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_CURSOR_POS,
        .setter = usr_textarea_set_cursor_pos,
        .getter = usr_textarea_get_cursor_pos,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_CURSOR_CLICK_POS,
        .setter = usr_textarea_set_cursor_click_pos,
        .getter = usr_textarea_get_cursor_click_pos,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_PASSWORD_MODE,
        .setter = usr_textarea_set_password_mode,
        .getter = usr_textarea_get_password_mode,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_PASSWORD_BULLET,
        .setter = usr_textarea_set_password_bullet,
        .getter = usr_textarea_get_password_bullet,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_ONE_LINE,
        .setter = usr_textarea_set_one_line,
        .getter = usr_textarea_get_one_line,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_ACCEPTED_CHARS,
        .setter = usr_textarea_set_accepted_chars,
        .getter = usr_textarea_get_accepted_chars,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_MAX_LENGTH,
        .setter = usr_textarea_set_max_length,
        .getter = usr_textarea_get_max_length,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_INSERT_REPLACE,
        .setter = usr_textarea_set_insert_replace,
        .getter = NULL,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_TEXT_SELECTION,
        .setter = usr_textarea_set_text_selection,
        .getter = usr_textarea_get_text_selection,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_PASSWORD_SHOW_TIME,
        .setter = usr_textarea_set_password_show_time,
        .getter = usr_textarea_get_password_show_time,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_LABEL,
        .setter = NULL,
        .getter = usr_textarea_get_label,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_TEXT_IS_SELECTED,
        .setter = NULL,
        .getter = usr_textarea_text_is_selected,
    },
    {
        .id = LV_PROPERTY_TEXTAREA_CURRENT_CHAR,
        .setter = NULL,
        .getter = usr_textarea_get_current_char,
    },
};
#endif

const lv_obj_class_t usr_textarea_class = {
    .constructor_cb = usr_textarea_constructor,
    .destructor_cb = usr_textarea_destructor,
    .event_cb = usr_textarea_event,
    .group_def = LV_OBJ_CLASS_GROUP_DEF_TRUE,
    .width_def = LV_DPI_DEF * 2,
    .height_def = LV_DPI_DEF,
    .editable = LV_OBJ_CLASS_EDITABLE_TRUE,
    .instance_size = sizeof(usr_textarea_t),
    ...
    .property_names = usr_textarea_property_names,
    .names_count = sizeof(usr_textarea_property_names) / sizeof(lv_property_name_t),
#endif
...
lv_obj_t *usr_textarea_create(lv_obj_t *parent)
{
    LV_LOG_INFO("begin");
...
void usr_textarea_add_char(lv_obj_t *obj, uint32_t c)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);

    usr_textarea_t *ta = (usr_textarea_t *)obj;
    ...
    /*The byte order may or may not need to be swapped here to get correct c_uni below,
      since usr_textarea_add_text is ordering bytes correctly before calling usr_textarea_add_char.
    ...
    usr_textarea_clear_selection(obj);                        /*Clear selection*/
    ...
    usr_textarea_set_cursor_pos(obj, usr_textarea_get_cursor_pos(obj) + 1);

    lv_obj_send_event(obj, LV_EVENT_VALUE_CHANGED, NULL);
}

void usr_textarea_add_text(lv_obj_t *obj, const char *txt)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
    LV_ASSERT_NULL(txt);
    ...
    if (usr_textarea_get_accepted_chars(obj) || usr_textarea_get_max_length(obj))
    {
        uint32_t i = 0;
        while (txt[i] != '\0')
        {
            uint32_t c = lv_text_encoded_next(txt, &i);
            usr_textarea_add_char(obj, lv_text_unicode_to_encoded(c));
        }
        return;
    }
    ...
    usr_textarea_clear_selection(obj);
    ...
    usr_textarea_set_cursor_pos(obj, usr_textarea_get_cursor_pos(obj) + lv_text_get_encoded_length(txt));

    lv_obj_send_event(obj, LV_EVENT_VALUE_CHANGED, NULL);
}

void usr_textarea_delete_char(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
    ...
    usr_textarea_set_cursor_pos(obj, ta->cursor.pos - 1);

    lv_obj_send_event(obj, LV_EVENT_VALUE_CHANGED, NULL);
}

void usr_textarea_delete_char_forward(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);

    uint32_t cp = usr_textarea_get_cursor_pos(obj);
    usr_textarea_set_cursor_pos(obj, cp + 1);
    if (cp != usr_textarea_get_cursor_pos(obj))
        usr_textarea_delete_char(obj);
}
...
void usr_textarea_set_text(lv_obj_t *obj, const char *txt)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
    LV_ASSERT_NULL(txt);
    ...
    if (usr_textarea_get_accepted_chars(obj) || usr_textarea_get_max_length(obj))
    {
        ...
        usr_textarea_set_cursor_pos(obj, USR_TEXTAREA_CURSOR_LAST);
        if (ta->pwd_mode)
        {
...
void usr_textarea_set_placeholder_text(lv_obj_t *obj, const char *txt)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
    LV_ASSERT_NULL(txt);
...
void usr_textarea_set_cursor_pos(lv_obj_t *obj, int32_t pos)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
    ...
    if (pos > (int32_t)len || pos == USR_TEXTAREA_CURSOR_LAST)
        pos = len;
...
void usr_textarea_set_cursor_click_pos(lv_obj_t *obj, bool en)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
void usr_textarea_set_password_mode(lv_obj_t *obj, bool en)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
void usr_textarea_set_password_bullet(lv_obj_t *obj, const char *bullet)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
void usr_textarea_set_one_line(lv_obj_t *obj, bool en)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
void usr_textarea_set_accepted_chars(lv_obj_t *obj, const char *list)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
void usr_textarea_set_max_length(lv_obj_t *obj, uint32_t num)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
void usr_textarea_set_insert_replace(lv_obj_t *obj, const char *txt)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
void usr_textarea_set_text_selection(lv_obj_t *obj, bool en)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
void usr_textarea_set_password_show_time(lv_obj_t *obj, uint32_t time)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
void usr_textarea_set_align(lv_obj_t *obj, lv_text_align_t align)
{
    ...
    case LV_TEXT_ALIGN_LEFT:
        lv_obj_align(usr_textarea_get_label(obj), LV_ALIGN_TOP_LEFT, 0, 0);
        break;
    case LV_TEXT_ALIGN_RIGHT:
        lv_obj_align(usr_textarea_get_label(obj), LV_ALIGN_TOP_RIGHT, 0, 0);
        break;
    case LV_TEXT_ALIGN_CENTER:
        lv_obj_align(usr_textarea_get_label(obj), LV_ALIGN_TOP_MID, 0, 0);
        break;
    }
}
...
const char *usr_textarea_get_text(const lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
const char *usr_textarea_get_placeholder_text(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
lv_obj_t *usr_textarea_get_label(const lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
uint32_t usr_textarea_get_cursor_pos(const lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
bool usr_textarea_get_cursor_click_pos(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
bool usr_textarea_get_password_mode(const lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
const char *usr_textarea_get_password_bullet(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
    ...
    if (lv_font_get_glyph_dsc(font, &g, USR_TEXTAREA_PWD_BULLET_UNICODE, 0))
        return LV_SYMBOL_BULLET;
    return "*";
}

bool usr_textarea_get_one_line(const lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
const char *usr_textarea_get_accepted_chars(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
uint32_t usr_textarea_get_max_length(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
bool usr_textarea_text_is_selected(const lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
bool usr_textarea_get_text_selection(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
uint32_t usr_textarea_get_password_show_time(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
uint32_t usr_textarea_get_current_char(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);

    const char *txt = usr_textarea_get_text(obj);
    usr_textarea_t *ta = (usr_textarea_t *)obj;
...
void usr_textarea_clear_selection(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
void usr_textarea_cursor_right(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);

    uint32_t cp = usr_textarea_get_cursor_pos(obj);
    cp++;
    usr_textarea_set_cursor_pos(obj, cp);
}

void usr_textarea_cursor_left(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
void usr_textarea_cursor_down(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
    ...
    lv_label_get_letter_pos(ta->label, usr_textarea_get_cursor_pos(obj), &pos);
    ...
    if (pos.y < lv_obj_get_height(ta->label))
    {
        ...
        usr_textarea_set_cursor_pos(obj, new_cur_pos);
        ta->cursor.valid_x = cur_valid_x_tmp;
    }
}

void usr_textarea_cursor_up(lv_obj_t *obj)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
...
static void usr_textarea_constructor(const lv_obj_class_t *class_p, lv_obj_t *obj)
{
    ...
    ta->pwd_tmp = NULL;
    ta->pwd_bullet = NULL;
    ta->pwd_show_time = USR_TEXTAREA_DEF_PWD_SHOW_TIME;
    ta->accepted_chars = NULL;
    ta->max_length = 0;
    ta->cursor.show = 1;
    /*It will be set to zero later (with zero value usr_textarea_set_cursor_pos(obj, 0); wouldn't do anything as there is no difference)*/
    ta->cursor.pos = 1;
    ...
    usr_textarea_set_cursor_pos(obj, 0);
...
static void usr_textarea_event(const lv_obj_class_t *class_p, lv_event_t *e)
{
    ...
    else if (code == LV_EVENT_KEY)
    {
        ...
        if (c == LV_KEY_RIGHT)
            usr_textarea_cursor_right(obj);
        else if (c == LV_KEY_LEFT)
            usr_textarea_cursor_left(obj);
        else if (c == LV_KEY_UP)
            usr_textarea_cursor_up(obj);
        else if (c == LV_KEY_DOWN)
            usr_textarea_cursor_down(obj);
        else if (c == LV_KEY_BACKSPACE)
            usr_textarea_delete_char(obj);
        else if (c == LV_KEY_DEL)
            usr_textarea_delete_char_forward(obj);
        else if (c == LV_KEY_HOME)
            usr_textarea_set_cursor_pos(obj, 0);
        else if (c == LV_KEY_END)
            usr_textarea_set_cursor_pos(obj, USR_TEXTAREA_CURSOR_LAST);
        else if (c == LV_KEY_ENTER && usr_textarea_get_one_line(obj))
            lv_obj_send_event(obj, LV_EVENT_READY, NULL);
        else
        {
            usr_textarea_add_char(obj, c);
        }
    }
...
static void pwd_char_hider(lv_obj_t *obj)
{
    ...
    const char *bullet = usr_textarea_get_password_bullet(obj);
...
static bool char_is_accepted(lv_obj_t *obj, uint32_t c)
{
    ...
    /*Too many characters?*/
    if (ta->max_length > 0 && lv_text_get_encoded_length(usr_textarea_get_text(obj)) >= ta->max_length)
    {
        return false;
    }
...
static void refr_cursor_area(lv_obj_t *obj)
{
    ...
    uint32_t cur_pos = usr_textarea_get_cursor_pos(obj);
    const char *txt = lv_label_get_text(ta->label);
...
static void update_cursor_position_on_click(lv_event_t *e)
{
    ...
    {
        char_id_at_click = USR_TEXTAREA_CURSOR_LAST;
        click_outside_label = true;
    }
    else
    {
    ...
    if (ta->text_sel_in_prog || code == LV_EVENT_PRESSED)
        usr_textarea_set_cursor_pos(obj, char_id_at_click);
...
static lv_result_t insert_handler(lv_obj_t *obj, const char *txt)
{
    ...
    if (ta_insert_replace)
    {
        ...
        {
            usr_textarea_add_text(obj, ta_insert_replace);
            return LV_RESULT_INVALID;
        }
    }
...
static void draw_placeholder(lv_event_t *e)
{
    ...
    if (txt[0] == '\0' && ta->placeholder_txt && ta->placeholder_txt[0] != 0)
    {
        ...
        lv_obj_init_draw_label_dsc(obj, USR_PART_TEXTAREA_PLACEHOLDER, &ph_dsc);
